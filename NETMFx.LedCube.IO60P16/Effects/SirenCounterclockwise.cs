...
namespace NETMFx.LedCube.Effects
{
    ...
    {
        public SirenCounterclockwise(NETMFx.LedCube.IO60P16.LedCube cube) : base(cube) { }
        public SirenCounterclockwise(NETMFx.LedCube.IO60P16.LedCube cube, int duration) : base(cube, duration) { }
